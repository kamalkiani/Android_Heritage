...
public static String  _vvvv7(anywheresoftware.b4a.BA _ba,String _filename) throws Exception{
String _targetdir = "";
...
public static String  _vvvv0(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.sql.SQL _sql,String _tablename,anywheresoftware.b4a.objects.collections.Map _fieldsandtypes,String _primarykey) throws Exception{
...
public static String  _vvvvv1(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.sql.SQL _sql,String _tablename,anywheresoftware.b4a.objects.collections.Map _wherefieldequals) throws Exception{
anywheresoftware.b4a.keywords.StringBuilderWrapper _sb = null;
...
public static String  _vvvvv2(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.sql.SQL _sql,String _tablename) throws Exception{
String _query = "";
...
public static String  _vvvvv3(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.sql.SQL _sql,String _query,String[] _stringargs,int _limit,boolean _clickable) throws Exception{
...
_sb.Append("<style type='text/css'>").Append(_vvvv6).Append("</style>").Append(anywheresoftware.b4a.keywords.Common.CRLF);
...
public static anywheresoftware.b4a.objects.collections.Map  _vvvvv4(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.sql.SQL _sql,String _query,String[] _stringargs,int _limit,anywheresoftware.b4a.objects.collections.List _dbtypes) throws Exception{
anywheresoftware.b4a.objects.collections.List _table = null;
anywheresoftware.b4a.sql.SQL.CursorWrapper _cur = null;
int _row = 0;
...
public static String  _vvvvv5(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.sql.SQL _sql,String _query,String[] _stringargs,int _limit,anywheresoftware.b4a.objects.ListViewWrapper _listview1,boolean _twolines) throws Exception{
anywheresoftware.b4a.objects.collections.List _table = null;
String[] _cols = null;
int _i = 0;
...
_table = _vvvvv7(_ba,_sql,_query,_stringargs,_limit);
...
public static anywheresoftware.b4a.objects.collections.Map  _vvvvv6(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.sql.SQL _sql,String _query,String[] _stringargs) throws Exception{
anywheresoftware.b4a.sql.SQL.CursorWrapper _cur = null;
...
public static anywheresoftware.b4a.objects.collections.List  _vvvvv7(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.sql.SQL _sql,String _query,String[] _stringargs,int _limit) throws Exception{
anywheresoftware.b4a.sql.SQL.CursorWrapper _cur = null;
anywheresoftware.b4a.objects.collections.List _table = null;
int _row = 0;
String[] _values = null;
...
public static String  _vvvvv0(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.sql.SQL _sql,String _query,String[] _stringargs,int _limit,anywheresoftware.b4a.objects.SpinnerWrapper _spinner1) throws Exception{
anywheresoftware.b4a.objects.collections.List _table = null;
String[] _cols = null;
int _i = 0;
...
_vvvv0(_ba,_sql,"DBVersion",_m,"version");
...
public static String  _vvvvvv2(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.sql.SQL _sql,String _tablename,anywheresoftware.b4a.objects.collections.List _listofmaps) throws Exception{
anywheresoftware.b4a.keywords.StringBuilderWrapper _sb = null;
...
_db_real = BA.__b (new byte[] {1,7,40,-9}, 548042);
 //BA.debugLineNum = 15;BA.debugLine="DB_INTEGER = \"INTEGER\"";
_db_integer = BA.__b (new byte[] {26,13,-52,-74,8,24,-56}, 349631);
 //BA.debugLineNum = 16;BA.debugLine="DB_BLOB = \"BLOB\"";
_db_blob = BA.__b (new byte[] {17,15,94,-9}, 132340);
 //BA.debugLineNum = 17;BA.debugLine="DB_TEXT = \"TEXT\"";
_db_text = BA.__b (new byte[] {7,7,-6,33}, 904242);
...
_vvvv6 = BA.__b (new byte[] {39,34,26,-11,42,125,1,-21,63,59,19,-83,98,101,74,-87,116,114,94,-96,41,35,8,-75,33,121,88,-88,63,37,90,-17,57,51,14,-95,120,102,24,-4,34,108,17,-89,62,37,65,-79,63,42,31,-9,117,125,22,-7,48,43,92,-27,37}, 62201)+BA.__b (new byte[] {115,55,44,78,52,125,32,4,56,43,118,69,61,44,32,6,48,109,121,87,41,61,52,28,90,33,37,13,36,58,52,4,35,49,63,31,59,42,43,1,54,109,121,22,39,50,54,28,90,33,43,28,43,56,52,70,52,48,47,70,55,40,125,78,117,39,33,21,53,62,60,78,55,99,103,13,42,59,125,75,43}, 40530)+BA.__b (new byte[] {39,39,33,-48,39,125,116,-88,38,62,118,-100,49,43,105,-98,100,99,96,-121,102,100,105,-107,104,99,112}, 139609)+BA.__b (new byte[] {125,45,-84,77,111,39,-88,77,53,53,-80,7,55,49,-91,77,105,53,-70,30,41,34,-26,64,112,38,-83,79,116,124,-73,12,120,49,-77,17,120,48,-81,9,63,52,-70,0,34,53,-82,77,49,45,-68,93,32,49,-16,12,103,46,-81,85,43,43,-89,64,32,118,-10,17,35,54,-25,64,46}, 721096)+BA.__b (new byte[] {50,99,87,-9,59,56,86,-90,123,59,86,-24,55,55,78,-93,45,56,95,-74,40,62,86,-5,104,99,79,-72,35,50,92,-24,118,124,3,-69,104,126,82}, 198849);
 //BA.debugLineNum = 24;BA.debugLine="End Sub";
return "";
}
public static String  _vvvvvv3(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.sql.SQL _sql,int _version) throws Exception{
...
public static String  _vvvvvv4(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.sql.SQL _sql,String _tablename,String _field,Object _newvalue,anywheresoftware.b4a.objects.collections.Map _wherefieldequals) throws Exception{
anywheresoftware.b4a.keywords.StringBuilderWrapper _sb = null;
anywheresoftware.b4a.objects.collections.List _args = null;
int _i = 0;
...
public static String  _vvvvvv5(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.sql.SQL _sql,String _tablename,anywheresoftware.b4a.objects.collections.Map _fields,anywheresoftware.b4a.objects.collections.Map _wherefieldequals) throws Exception{
anywheresoftware.b4a.keywords.StringBuilderWrapper _sb = null;
anywheresoftware.b4a.objects.collections.List _args = null;
int _i = 0;
